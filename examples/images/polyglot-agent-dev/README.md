...
- **Go**: go, gopls, dlv, goimports
- **Node**: Node.js LTS, corepack, pnpm, yarn
...
- The image is intentionally not minimal; trim the toolchains you don't need to
  speed up builds.
- For multi-arch builds pass `--build-arg TARGETARCH=arm64` (or use buildx).
